...
public class Matrix {
    ...
    public int[][] sumMatrix(int[][] matrixB) {                                           //функция - сумма матриц - для 3 задания
    ...
    public int sumMainDiagonal() {                                                       //функция - сумма диагоналей матрицы - для 1 задания
        int sumMain = 0;
        System.out.println("\nМатрица:\n");
        ...
        return sumMain;                                                    //вывод суммы главной диагонали
    }
    public int sumSideDiagonal(){
        int sumSide = 0;
        ...
        return sumSide;                                                                 //вывод суммы побочной диагонали
    }
